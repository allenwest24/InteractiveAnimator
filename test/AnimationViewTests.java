...
public class AnimationViewTests {
  ...
  public void testSvgDemoForSmallDemo() {
    ...
    String expectedOutput = "<svg width=\"360\" height=\"360\" version=\"1.1\" " +
            ...
            "from=\"200\" to=\"300\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"500ms\" dur=\"2000ms\" attributeName=\"width\" " +
            "from=\"50\" to=\"50\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"500ms\" dur=\"2000ms\" attributeName=\"height\" " +
            "from=\"100\" to=\"100\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"500ms\" dur=\"2000ms\" attributeName=\"fill\" " +
            "from=\"rgb(255,0,0)\" to=\"rgb(255,0,0)\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2500ms\" dur=\"50ms\" attributeName=\"x\" " +
            "from=\"300\" to=\"300\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2500ms\" dur=\"50ms\" attributeName=\"y\" " +
            "from=\"300\" to=\"300\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2500ms\" dur=\"50ms\" attributeName=\"width\" " +
            "from=\"50\" to=\"50\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2500ms\" dur=\"50ms\" attributeName=\"height\" " +
            "from=\"100\" to=\"100\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2500ms\" dur=\"50ms\" attributeName=\"fill\" " +
            "from=\"rgb(255,0,0)\" to=\"rgb(255,0,0)\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2550ms\" dur=\"950ms\" attributeName=\"x\" " +
            "from=\"300\" to=\"300\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2550ms\" dur=\"950ms\" attributeName=\"y\" " +
            "from=\"300\" to=\"300\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2550ms\" dur=\"950ms\" attributeName=\"width\" " +
            "from=\"50\" to=\"25\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2550ms\" dur=\"950ms\" attributeName=\"height\" " +
            "from=\"100\" to=\"100\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2550ms\" dur=\"950ms\" attributeName=\"fill\" " +
            "from=\"rgb(255,0,0)\" to=\"rgb(255,0,0)\" fill=\"freeze\" />\n" +
            ...
            "from=\"300\" to=\"200\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"3500ms\" dur=\"1500ms\" attributeName=\"width\" " +
            "from=\"25\" to=\"25\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"3500ms\" dur=\"1500ms\" attributeName=\"height\" " +
            "from=\"100\" to=\"100\" fill=\"freeze\" />\n" +
            "<animate attributeType=\"xml\" begin=\"3500ms\" dur=\"1500ms\" attributeName=\"fill\" " +
            "from=\"rgb(255,0,0)\" to=\"rgb(255,0,0)\" fill=\"freeze\" />\n" +
            "</rect>\n" +
            ...
            "<animate attributeType=\"xml\" begin=\"300ms\" dur=\"700ms\" attributeName=\"fill\" " +
            "from=\"rgb(0,0,255)\" to=\"rgb(0,0,255)\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"1000ms\" dur=\"1500ms\" attributeName=\"cx\" " +
            "from=\"440\" to=\"440\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"1000ms\" dur=\"1500ms\" attributeName=\"cy\" " +
            "from=\"70\" to=\"250\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"1000ms\" dur=\"1500ms\" attributeName=\"rx\" " +
            "from=\"120\" to=\"120\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"1000ms\" dur=\"1500ms\" attributeName=\"ry\" " +
            "from=\"60\" to=\"60\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"1000ms\" dur=\"1500ms\" attributeName=\"fill\" " +
            "from=\"rgb(0,0,255)\" to=\"rgb(0,0,255)\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2500ms\" dur=\"1000ms\" attributeName=\"cx\" " +
            "from=\"440\" to=\"440\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2500ms\" dur=\"1000ms\" attributeName=\"cy\" " +
            "from=\"250\" to=\"370\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2500ms\" dur=\"1000ms\" attributeName=\"rx\" " +
            "from=\"120\" to=\"120\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2500ms\" dur=\"1000ms\" attributeName=\"ry\" " +
            "from=\"60\" to=\"60\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"2500ms\" dur=\"1000ms\" attributeName=\"fill\" " +
            "from=\"rgb(0,0,255)\" to=\"rgb(0,170,85)\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"3500ms\" dur=\"500ms\" attributeName=\"cx\" " +
            "from=\"440\" to=\"440\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"3500ms\" dur=\"500ms\" attributeName=\"cy\" " +
            "from=\"370\" to=\"370\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"3500ms\" dur=\"500ms\" attributeName=\"rx\" " +
            "from=\"120\" to=\"120\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"3500ms\" dur=\"500ms\" attributeName=\"ry\" " +
            "from=\"60\" to=\"60\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"3500ms\" dur=\"500ms\" attributeName=\"fill\" " +
            "from=\"rgb(0,170,85)\" to=\"rgb(0,255,0)\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"4000ms\" dur=\"1000ms\" attributeName=\"cx\" " +
            "from=\"440\" to=\"440\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"4000ms\" dur=\"1000ms\" attributeName=\"cy\" " +
            "from=\"370\" to=\"370\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"4000ms\" dur=\"1000ms\" attributeName=\"rx\" " +
            "from=\"120\" to=\"120\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"4000ms\" dur=\"1000ms\" attributeName=\"ry\" " +
            "from=\"60\" to=\"60\" fill=\"remove\" />\n" +
            "<animate attributeType=\"xml\" begin=\"4000ms\" dur=\"1000ms\" attributeName=\"fill\" " +
  ...
  @Test
  public void testThatRefreshDoesNothingText() {
    this.setUp("smalldemo.txt", false, 1);
    String expectedOutput = "canvas 200 70 360 360\n" +
            "shape R rectangle\n" +
            "motion R 1 200 200 50 100 255 0 0 10 200 200 50 100 255 0 0\n" +
  ...
  @Test
  public void testThatRefreshDoesNothingSVG() {
    this.setUp("smalldemo.txt", true, 20);
    String expectedOutput = "<svg width=\"360\" height=\"360\" version=\"1.1\" " +
            "xmlns=\"http://www.w3.org/2000/svg\">\n" +
            "<rect id=\"R\" x=\"200\" y=\"200\" width=\"50\" height=\"100\" fill=\"" +
